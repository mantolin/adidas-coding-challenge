 ...
 */
package com.mantolin.adidascodingchallenge.emailservice.config;
...
public class SwaggerConfig {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.mantolin.adidascodingchallenge.emailservice"))
                .paths(regex("/rest.*"))
                .build();
    }
